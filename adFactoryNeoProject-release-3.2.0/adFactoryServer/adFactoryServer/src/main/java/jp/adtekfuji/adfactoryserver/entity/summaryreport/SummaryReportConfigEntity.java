...
public class SummaryReportConfigEntity implements Serializable {
     ...
     * コンストラクタ
     */
    public SummaryReportConfigEntity() {
        this.title = "";
        this.disable = false;
     ...
     */
    public SummaryReportConfigEntity(String title) {
        this();
        this.title = title;
    }
     ...
     */
    public SummaryReportConfigEntity(String title, boolean rootFlag) {
        this();
        this.title = title;
     ...
     */
    public SummaryReportConfigEntity(boolean createFlag) {
        this();
     ...
     * @return true:一致している
     */
    public boolean displayInfoEquals(SummaryReportConfigEntity info) {
     ...
     */
    @Override
    public SummaryReportConfigEntity clone() {
        SummaryReportConfigEntity entity = new SummaryReportConfigEntity();
