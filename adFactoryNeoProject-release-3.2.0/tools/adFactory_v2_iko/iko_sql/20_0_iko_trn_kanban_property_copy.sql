...
insert
into iko_trn_kanban_property

select

a_kanbann_property_id
,a_fk_kanban_id
...
from trn_kanban_property a

'
)
as LINK1
(
a_kanbann_property_id int
,a_fk_kanban_id int
...
VACUUM  FULL    ANALYZE     iko_trn_kanban_property   ;
