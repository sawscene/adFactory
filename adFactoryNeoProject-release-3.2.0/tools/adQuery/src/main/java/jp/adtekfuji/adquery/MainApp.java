...
public class MainApp extends Application {
    ...
    public static final String PACKAGE_NAME = "adQuery";
    ...
    public void start(Stage stage) throws Exception {
        ...
        try {
            ...
            dataQuery = new DataQuery(this.getParameters());
            if (true == dataQuery.getArgumentJudge()) {
                dataQuery.searchActuals();
            } else {
                // 起動パラメータが不正です
                logger.error("Invalid boot parameters.");
                System.exit(3);
            }
