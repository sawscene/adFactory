 ...
 */
package jp.adtekfuji.adquery.entity;
...
public class ReportOutSearchResult {
    private List<ReportOutInfoEntity> actuals = new ArrayList<>();
    private long actualsTo;
    private long propsTo;
    private List<ActualPropertyEntity> remainingProps;
    private List<ReportOutSummaryInfoEntity> workActuals = new ArrayList<>();
