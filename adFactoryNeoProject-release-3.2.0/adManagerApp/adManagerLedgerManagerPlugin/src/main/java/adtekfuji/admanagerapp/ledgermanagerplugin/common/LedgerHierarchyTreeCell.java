 ...
 * @author ta.ito
 */
public class LedgerHierarchyTreeCell extends TreeCell<LedgerHierarchyInfoEntity> {

    public LedgerHierarchyTreeCell() {
    }

    @Override
    protected void updateItem(LedgerHierarchyInfoEntity item, boolean empty) {
