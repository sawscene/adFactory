 ...
 */
package adtekfuji.admanagerapp.summaryreportplugin;
 ...
 * @author e.mori
 */
public class AdManagerAppSummaryReportPluginMenu implements AdManagerAppMainMenuInterface {

    private final Properties properties = AdProperty.getProperties();

    @Override
    public String getDisplayName() {
        return LocaleUtils.getString("key.EditSummaryReportTitle");
    }
