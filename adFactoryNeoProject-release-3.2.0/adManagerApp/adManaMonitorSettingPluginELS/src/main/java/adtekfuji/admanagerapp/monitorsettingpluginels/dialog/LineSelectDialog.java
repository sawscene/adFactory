...
public class LineSelectDialog {
    ...
    public static ButtonType showDialogLineEntity(Event event) {
        ...
        ButtonType ret = sc.showComponentDialog(LocaleUtils.getString("key.Equipment"), "EquipmentSelectionCompo", selectDialogEntity, (Stage) ((Node) event.getSource()).getScene().getWindow());
