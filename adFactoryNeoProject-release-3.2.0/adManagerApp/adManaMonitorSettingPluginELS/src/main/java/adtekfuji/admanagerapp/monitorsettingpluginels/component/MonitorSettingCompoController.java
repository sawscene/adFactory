 ...
 * @author s-heya
 */
@FxComponent(id = "MonitorSettingCompoELS", fxmlPath = "/fxml/compo/monitor_setting_compo.fxml")
public class MonitorSettingCompoController implements Initializable, ArgumentDelivery, ComponentHandler {
    ...
    private MonitorSettingELS setting = null;

    // 最初に表示された情報
    private MonitorSettingELS cloneSetting;
    ...
    private void createScene(long equipmentId, AndonMonitorTypeEnum monitorType, boolean isUpdateClone) {
        ...
        try {
            ...
            final MonitorSettingCompoController self = this;
            ...
            Task task = new Task<AndonSettingController>() {
                ...
                protected AndonSettingController call() throws Exception {
                    ...
                    if (Objects.isNull(monitorType)) {
                        ...
                        setting = (MonitorSettingELS) monitorSettingFacade.getLineSetting(equipmentId, MonitorSettingELS.class);
                    ...
                    switch (type) {
                        ...
                        case AGENDA: {
                            ...
                            AgendaMonitorSettingController controller = new AgendaMonitorSettingController(self, equipmentId, setting.getAgendaMonitorSetting(), null, true);
                            return controller;
                        }
                        default:
                            break;
                ...
                protected void succeeded() {
                    ...
                    try {
                        ...
                        if (isUpdateClone) {
                            MonitorSettingELS setting = getRegistData();
    ...
    private boolean registData() {
        ...
        try {
            ...
            if (Objects.isNull(this.monitorId)) {
                return false;
            }
            ...
            final MonitorSettingELS targetSetting = controller.getInputResult();
     ...
     * @return
     */
    private MonitorSettingELS getRegistData() {
    ...
    private boolean isChanged() {
        MonitorSettingELS currentSetting = getRegistData();
