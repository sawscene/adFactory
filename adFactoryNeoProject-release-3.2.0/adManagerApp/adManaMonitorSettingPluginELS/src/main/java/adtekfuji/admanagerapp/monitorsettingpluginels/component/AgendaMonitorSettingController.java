...
import adtekfuji.admanagerapp.monitorsettingpluginels.dialog.KanbanSelectDialog;
import adtekfuji.admanagerapp.monitorsettingpluginels.dialog.LineSelectDialog;
import adtekfuji.admanagerapp.monitorsettingpluginels.dialog.OrganizationSelectDialog;
import java.net.URL;
...
public class AgendaMonitorSettingController extends AndonSettingController implements ChangeListener<Number> {
     ...
     * @param showAll
     */
    public AgendaMonitorSettingController(MonitorSettingCompoController settingController, long monitorId, AgendaMonitorSetting setting, Stage parent, boolean showAll) {
    ...
    public MonitorSettingELS getInputResult() {
        ...
        MonitorSettingELS result = MonitorSettingELS.create();
