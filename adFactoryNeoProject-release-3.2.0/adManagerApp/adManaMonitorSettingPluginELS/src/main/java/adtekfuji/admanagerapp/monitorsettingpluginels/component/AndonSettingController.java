...
public abstract class AndonSettingController extends VBox {
    ...
    private MonitorSettingCompoController componentController;
    ...
    public abstract MonitorSettingELS getInputResult();

    public abstract boolean isValidItems();

    public MonitorSettingCompoController getComponentController() {
        return componentController;
    }

    public void setComponentController(MonitorSettingCompoController componentController) {
