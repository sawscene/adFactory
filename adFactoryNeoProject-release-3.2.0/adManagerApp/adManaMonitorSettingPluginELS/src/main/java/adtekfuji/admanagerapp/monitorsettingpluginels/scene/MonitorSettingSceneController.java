 ...
 */
package adtekfuji.admanagerapp.monitorsettingpluginels.scene;
 ...
 * @author s-heya
 */
@FxScene(id = "MonitorSettingSceneELS", fxmlPath = "/fxml/monitorsettingpluginels/monitor_setting_scene.fxml")
public class MonitorSettingSceneController implements Initializable {
