 ...
 * @author e.mori
 */
public class AdManagerAppEquipmentEditPluginMenu implements AdManagerAppMainMenuInterface {
    ...
    public void onSelectMenuAction() {
        ...
        if (!sc.trans("EquipmentEditScene")) {
            return;
        }
    ...
    public LicenseOptionType getOptionType() {
        return LicenseOptionType.EquipmentEditor;
    }
