...
public class WorkRecordFactory extends AbstractRecordFactory<WorkSetting> {
    ...
    protected Record createRecord(WorkSetting work) {
        ...
        cells.add(new CellTextField(record, work.titleProperty()).setPrefWidth(180.0).addStyleClass("ContentTextBox"));
        ...
        cells.add(numericField.setPrefWidth(120.0).addStyleClass("ContentTextBox"));
        // 開始時間
        cells.add(new CellTimeStampField(record, work.startWorkTimeProperty()).setPrefWidth(120.0).addStyleClass("ContentTextBox"));
        // 終了時間
        cells.add(new CellTimeStampField(record, work.endWorkTimeProperty()).setPrefWidth(120.0).addStyleClass("ContentTextBox"));
