 ...
 */
package adtekfuji.admanagerapp.monitorsettingplugintp.scene;
 ...
 * @author s-heya
 */
@FxScene(id = "MonitorSettingScene", fxmlPath = "/fxml/monitorsettingplugintp/monitor_setting_scene.fxml")
