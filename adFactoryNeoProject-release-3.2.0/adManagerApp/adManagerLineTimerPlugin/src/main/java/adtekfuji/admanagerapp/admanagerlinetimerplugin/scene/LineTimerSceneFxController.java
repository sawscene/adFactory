 ...
 */
package adtekfuji.admanagerapp.admanagerlinetimerplugin.scene;
 ...
 * @author e.mori
 */
@FxScene(id = "LineTimerScene", fxmlPath = "/fxml/scene/line_timer_scene.fxml")
public class LineTimerSceneFxController implements Initializable {
