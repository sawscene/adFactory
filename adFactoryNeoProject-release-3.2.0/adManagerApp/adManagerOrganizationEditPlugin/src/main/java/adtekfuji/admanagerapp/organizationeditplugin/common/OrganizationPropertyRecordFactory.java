 ...
 * @author e.mori
 */
public class OrganizationPropertyRecordFactory extends AbstractRecordFactory<OrganizationPropertyInfoEntity> {
    ...
    public OrganizationPropertyRecordFactory(Table table, LinkedList<OrganizationPropertyInfoEntity> entitys) {
        super(table, entitys);
    }
    ...
    @Override
    protected Record createRecord(OrganizationPropertyInfoEntity entity) {
        ...
        //プロパティ名
        cells.add(new CellRegexTextField(record, "^.{0,255}$", entity.organizationPropNameProperty(), CellRegexTextField.RegexType.STRING).addStyleClass("ContentTextBox"));
        //プロパティタイプ名
        cells.add(new CellComboBox<>(record, Arrays.asList(CustomPropertyTypeEnum.values()), new CustomPropertyTypeComboBoxCellFactory(), comboCellFactory, entity.organizationPropTypeProperty()).addStyleClass("ContentComboBox"));
        //プロパティ値
        cells.add(new CellTextField(record, entity.organizationPropValueProperty()).addStyleClass("ContentTextBox"));
    ...
    public Class getEntityClass() {
        return OrganizationPropertyInfoEntity.class;
    }
}
