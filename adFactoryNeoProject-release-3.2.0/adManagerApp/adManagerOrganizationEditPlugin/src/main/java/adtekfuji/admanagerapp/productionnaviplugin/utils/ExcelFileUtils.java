...
public class ExcelFileUtils {
     ...
     * コンストラクタ
     *
     * @param simpleDateFormat 日付フォーマット
     */
    public ExcelFileUtils(SimpleDateFormat simpleDateFormat) {
     ...
     * @return データ
     */
    public List<List<String>> readExcel(String filename, int readStartRow, int readCols, Integer readRowCount) {
     ...
     * @return 読み込み結果
     */
    private List<List<String>> excelXlsx(String filename, int readStartRow, int readCols, Integer readRowCount) {
     ...
     * @return 読み込み結果
     */
    private List<List<String>> excelXls(String filename, int readStartRow, int readCols, Integer readRowCount) {
        List<List<String>> values = new ArrayList<>();
