 ...
 * @author nar-nakamura
 */
public class TableNumberCell extends TableCell<WorkReportRowInfo, String> {

    private static final List<String> UNEDITABLE = Arrays.asList("workNumberColumn", "orderNumberColumn", "finalNumColumn", "defectNumColumn");
