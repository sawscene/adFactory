...
public abstract class AndonSettingController extends VBox {
    ...
    private AndonSettingCompoFxController componentController;
    ...
    public abstract AndonMonitorLineProductSetting getInputResult();

    public abstract boolean isValidItems();

    public AndonSettingCompoFxController getComponentController() {
        return componentController;
    }

    public void setComponentController(AndonSettingCompoFxController componentController) {
