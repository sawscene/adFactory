 ...
 */
package adtekfuji.admanagerapp.andonsetting.scene;
 ...
 * @author e.mori
 */
@FxScene(id = "AndonSettingScene", fxmlPath = "/fxml/scene/andon_setting_scene.fxml")
public class AndonSettingSceneFxController implements Initializable {
