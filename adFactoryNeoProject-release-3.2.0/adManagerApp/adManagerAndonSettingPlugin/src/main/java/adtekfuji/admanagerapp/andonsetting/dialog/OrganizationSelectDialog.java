...
public class OrganizationSelectDialog {
    ...
    public static ButtonType showDialog(ActionEvent event) {
        ...
        try {
            ...
            ret = sc.showComponentDialog(LocaleUtils.getString("key.Organization"), "OrganizationSelectionCompo", selectDialogEntity, (Stage) ((Node) event.getSource()).getScene().getWindow(), true);
