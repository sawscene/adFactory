 ...
 * @author s-heya
 */
public class CustomPluginMenu implements AdManagerAppMainMenuInterface {
    ...
    public String getDisplayName() {
        ...
        return LocaleUtils.getString("key.EditEquipmentTitle");
    }
    ...
    public List<RoleAuthorityType> getRoleAuthorityType() {
        return Arrays.asList((RoleAuthorityType) CustomRoleAuthorityTypeEnum.CUSTOM_FEATURE1, (RoleAuthorityType) CustomRoleAuthorityTypeEnum.CUSTOM_FEATURE2);
    }
