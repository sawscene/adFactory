 ...
 * @author e-mori
 */
public class WorkPlanWorkKanbanStarttimeOffsetFactory extends AbstractRecordFactory<SimpleStringProperty> {

    public WorkPlanWorkKanbanStarttimeOffsetFactory(Table table, LinkedList<SimpleStringProperty> entitys) {
        super(table, entitys);
    }
