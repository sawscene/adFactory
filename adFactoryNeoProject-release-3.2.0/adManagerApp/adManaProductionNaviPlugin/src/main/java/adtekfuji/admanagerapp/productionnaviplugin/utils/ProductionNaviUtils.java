...
public class ProductionNaviUtils {
    ...
    // タブ：CSV形式（ヘッダ名指定）
    public static final int IMPORT_TAB_IDX_HEADER = 2;
    ...
    // タブ：CSV形式（ヘッダ名指定）：工程情報
    public static final int WORKPLAN_TAB_IDX_HAEDER_WORK = 0;
    // タブ：CSV形式（ヘッダ名指定）：工程プロパティ情報
    public static final int WORKPLAN_TAB_IDX_HAEDER_WORK_PROP = 1;
    // タブ：CSV形式（ヘッダ名指定）：工程順情報
    public static final int WORKPLAN_TAB_IDX_HAEDER_WORKFLOW = 2;
    // タブ：CSV形式（ヘッダ名指定）：工程順プロパティ情報
    public static final int WORKPLAN_TAB_IDX_HAEDER_WORKFLOW_PROP = 3;
    // タブ：CSV形式（ヘッダ名指定）：カンバン情報情報
    public static final int WORKPLAN_TAB_IDX_HAEDER_WORK_KANBAN = 4;
    // タブ：CSV形式（ヘッダ名指定）：工程カンバンプロパティ情報
    public static final int WORKPLAN_TAB_IDX_HAEDER_WORK_KANBAN_PROP = 5;
    // タブ：CSV形式（ヘッダ名指定）：工程カンバン情報情報
    public static final int WORKPLAN_TAB_IDX_HAEDER_KANBAN = 6;
    // タブ：CSV形式（ヘッダ名指定）：工程カンバンプロパティ情報
    public static final int WORKPLAN_TAB_IDX_HAEDER_KANBAN_PROP = 7;
