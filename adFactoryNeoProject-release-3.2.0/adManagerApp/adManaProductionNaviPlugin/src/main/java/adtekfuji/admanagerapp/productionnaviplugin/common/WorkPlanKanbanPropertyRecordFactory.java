 ...
 * @author e.mori
 */
public class WorkPlanKanbanPropertyRecordFactory extends AbstractRecordFactory<KanbanPropertyInfoEntity> {
     ...
     */
    public WorkPlanKanbanPropertyRecordFactory(Table table, LinkedList<KanbanPropertyInfoEntity> entities) {
