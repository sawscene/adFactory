...
public class ProductionNaviPropertyConstants {
    ...
    public static final String WORKFLOW_NAME_KEY = "key.OrderProcessesName"; // 工程順名
    public static final String MODEL_NAME_KEY = "key.ModelName"; // モデル名
    public static final String ORDER_NUMBER_KEY = "key.orderNum"; // "オーダー番号"
    public static final String SERIAL_NUMBER_KEY = "key.SerialNumber"; // シリアル
    public static final List<String> TitleKeyList = Arrays.asList(WORKFLOW_NAME_KEY, MODEL_NAME_KEY, ORDER_NUMBER_KEY, SERIAL_NUMBER_KEY);
    ...
    public static final List<String> InitTitleKeyList = TitleKeyList;
    ...
    public static final String SELECT_PROD_HEADER_PATH = "select.production.import.header.path";// インポートパス設定
    public static final String SELECT_PROD_TAB = "select.production.import.tab";// インポートパス設定
    public static final String SELECT_PROD_FOLDER_PATH = "select.production.export.folder.path";// インポートパス設定
    
    // Asprova連携
    public static final String SELECT_LINK_ASP_TAB = "select.link.asprova.tab";// 選択タブ
    public static final String SELECT_ASP_MONTHLY_PLAN_FOLDER_PATH = "select.asprova.monthlyplan.folder.path"; // 月初計画ファイル読込フォルダパス
    public static final String SELECT_ASP_PLAN_FOLDER_PATH = "select.asprova.plan.folder.path";// 生産計画ファイル読み込みフォルダパス
    public static final String SELECT_ASP_EXPORT_FOLDER_PATH = "select.asprova.export.folder.path";// 生産実績取り出しフォルダパス
    public static final String SELECT_ASP_BOM_FOLDER_PATH = "select.asprova.bom.folder.path";// BOMファイル読み込みフォルダパス
    public static final String SELECT_ASP_PLAN_KANBAN_HIER = "select.asprova.plan.kanban.hierarchy";// 生産計画ファイル読み込み カンバン階層
    public static final String SELECT_ASP_EXPORT_KANBAN_HIER = "select.asprova.export.kanban.hierarchy";// 生産実績取り出し カンバン階層
    public static final String SELECT_ASP_BOM_WORK_HIER = "select.asprova.bom.work.hierarchy";//  BOMファイル読み込み 工程階層
    public static final String SELECT_ASP_BOM_WORKFLOW_HIER = "select.asprova.bom.workflow.hierarchy";// BOMファイル読み込み 工程順階層
    public static final String ASP_PLAN_ORGANIZATION = "asprova.plan.organization";// 生産計画ファイル読み込み カンバンに使用する組織
    public static final String ASP_BOM_ADD_DISPLAYITEMS = "asprova.bom.add.displayItems";// BOMファイル読み込み 工程表示項目
    ...
    // CSV形式（ヘッダ名指定）_初期値
    public static final String INIT_PROD_HEADER_CSV_VALUE = "";

    // カンバン
    public static final String INIT_PROD_KANBAN_CSV_FILE = "kanban.csv";
    public static final String INIT_PROD_KANBAN_CSV_ENCODE = "S-JIS";
    ...
    // カンバンプロパティ情報 - 工程順名
    public static final String INIT_PROD_WORKFLOWPROP_CSV_NAME = "";
    public static final String INIT_PROD_WORKFLOWPROP_XLS_NAME = "";
    // カンバンプロパティ情報 - プロパティ名
    ...
    // カンバンプロパティ情報 (フォーマット２) - 工程順名
    public static final String INIT_PROD_KANBANPROP_F2_CSV_WORKFLOW_NAME = "";
    public static final String INIT_PROD_KANBANPROP_F2_XLS_WORKFLOW_NAME = "";
