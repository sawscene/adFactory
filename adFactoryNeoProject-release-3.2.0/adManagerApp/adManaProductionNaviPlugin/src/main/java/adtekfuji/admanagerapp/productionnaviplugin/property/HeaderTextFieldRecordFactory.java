 ...
 * @author (AQTOR)Koga
 */
public class HeaderTextFieldRecordFactory extends AbstractRecordFactory<SimpleStringProperty> {

    public HeaderTextFieldRecordFactory(Table table, LinkedList<SimpleStringProperty> entities) {
    ...
    protected Record createRecord(SimpleStringProperty value) {
        ...
        cells.add(new CellTextField(record, value).setPrefWidth(165.0));
