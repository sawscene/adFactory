 ...
 * @author e-mori
 */
public class WorkPlanKanbanLedgerPermanenceData {
    ...
    public WorkPlanKanbanLedgerPermanenceData() {
    }

    public WorkPlanKanbanLedgerPermanenceData(String ledgerFilePass, KanbanInfoEntity kanbanInfoEntity, List<WorkKanbanInfoEntity> workKanbanInfoEntitys, List<WorkKanbanInfoEntity> separateworkWorkKanbanInfoEntitys, List<ActualResultEntity> actualResultInfoEntitys) {
