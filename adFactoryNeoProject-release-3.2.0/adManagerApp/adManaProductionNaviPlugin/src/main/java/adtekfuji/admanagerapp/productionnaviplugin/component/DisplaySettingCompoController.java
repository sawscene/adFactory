...
//    private ListView<OrganizationInfoEntity> organizationList;
    ...
    private String masterDataSettingTitle = "";
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        masterDataSettingTitle
                = ProductionNaviPropertyConstants.TitleKeyList
                .stream()
                .map(LocaleUtils::getString)
                .collect(Collectors.joining(ProductionNaviPropertyConstants.TITLE_SEPARATOR));
...
//                    loadShowOrganizationSetting(prop);
    ...
    private void loadTitleDisplaySetting(Properties prop) {
        String select = prop.getProperty(ProductionNaviPropertyConstants.KEY_SETTING_TITLE, this.masterDataSettingTitle);
        String master = prop.getProperty(ProductionNaviPropertyConstants.MASTER_SETTING_TITLE, this.masterDataSettingTitle);
