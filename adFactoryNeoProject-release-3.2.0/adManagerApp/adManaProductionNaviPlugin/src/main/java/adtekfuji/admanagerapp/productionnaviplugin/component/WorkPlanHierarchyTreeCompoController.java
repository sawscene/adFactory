 ...
 * @since 2018/09/28
 */
@FxComponent(id = "WorkPlanHierarchyTreeCompo", fxmlPath = "/fxml/compo/work_plan_hierarchy_tree_compo.fxml")
public class WorkPlanHierarchyTreeCompoController implements Initializable, ArgumentDelivery {
    ...
    private void reRenderTree() {
        hierarchyTree.setCellFactory((TreeView<KanbanHierarchyInfoEntity> p) -> new WorkPlanKanbanHierarchyTreeCell());
    }
}
