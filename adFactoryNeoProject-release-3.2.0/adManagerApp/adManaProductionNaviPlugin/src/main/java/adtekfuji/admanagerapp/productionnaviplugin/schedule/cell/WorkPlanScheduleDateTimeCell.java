 ...
 */
public class WorkPlanScheduleDateTimeCell extends GridPane {
     ...
     */
    public WorkPlanScheduleDateTimeCell(String serialName, double prefWidth, double prefHight) {
        //セル生成
...
//            Label time;
//            if (timeNum < 10) {
//                time = new Label("0" + timeNum + ":00");
//                time.setAlignment(Pos.CENTER);
//                time.setPrefSize(prefWidth / 48, Control.USE_COMPUTED_SIZE);
//                time.setMaxSize(Control.USE_PREF_SIZE, Control.USE_PREF_SIZE);
//                time.setMinSize(Control.USE_PREF_SIZE, Control.USE_PREF_SIZE);
//                time.setRotate(270);
//                timePane.getChildren().add(time);
...
//        }
    ...
    private void setStyle() {
        WorkPlanStyleInjecter.setBorderColorStyle(this, "gray");
    }
}
