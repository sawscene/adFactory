 ...
 */
package adtekfuji.admanagerapp.productionnaviplugin.scene;
 ...
 * @since 2018/09/28
 */
@FxScene(id = "PuroductionNaviScene", fxmlPath = "/fxml/scene/production_navi_scene.fxml")
public class WorkPlanSceneController implements Initializable {
