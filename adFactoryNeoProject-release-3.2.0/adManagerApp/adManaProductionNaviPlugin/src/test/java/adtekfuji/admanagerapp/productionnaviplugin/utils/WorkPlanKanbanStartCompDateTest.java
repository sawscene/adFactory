 ...
 * @author yu.kikukawa
 */
public class WorkPlanKanbanStartCompDateTest {

    private final DateFormat df = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");

    public WorkPlanKanbanStartCompDateTest() {
    }
    ...
    public void testGetWorkKanbanCompDateTime() throws ParseException {
        ...
        Date result = WorkPlanKanbanStartCompDate.getWorkKanbanCompDateTime(wKanbans);
        ...
        result = WorkPlanKanbanStartCompDate.getWorkKanbanCompDateTime(wKanbans);
        assertEquals(expResult, result);
    ...
    public void testGetWorkKanbanStartDateTime() throws ParseException {
        ...
        Date result = WorkPlanKanbanStartCompDate.getWorkKanbanStartDateTime(wKanbans);
        assertEquals(expResult, result);
        ...
        result = WorkPlanKanbanStartCompDate.getWorkKanbanStartDateTime(wKanbans);
        assertEquals(expResult, result);
