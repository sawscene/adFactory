...
#define MyName "adInterface TIPS"
...
AllowNoIcons=yes
AllowUNCPath=no
OutputBaseFilename=adInterfaceTIPSSetup_v{#MyAppVersion}
Compression=lzma
...
[Files]
Source: "plugin\DbImportService.jar"; DestDir: "{app}\plugin"; Flags: ignoreversion; 
Source: "plugin\DbOutputService.jar"; DestDir: "{app}\plugin"; Flags: ignoreversion;
