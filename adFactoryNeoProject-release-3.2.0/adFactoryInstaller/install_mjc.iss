...
#define MyAppName "adFactory MJC"
...
AllowNoIcons=yes
AllowUNCPath=no
OutputBaseFilename=adFactoryMJCSetup_v{#MyAppVersion}
Compression=lzma
...
[Files]
Source: "version.ini"; DestDir: "{app}"; DestName: "version_mjc.ini"; Flags: ignoreversion
Source: "conf\mjc\adAccessoryPlugins.xml"; DestDir: "{app}\conf"; Flags: ignoreversion uninsneveruninstall; Components: management\adManager
Source: "deploy\softwareupdate_mjc.xml"; DestDir: "{app}\deploy"; DestName: "softwareupdate.xml"; Flags: ignoreversion uninsneveruninstall
...
[InstallDelete]
Type: files; Name: "{app}\version_mjc.ini"
