...
AllowNoIcons=yes
AllowUNCPath=no
OutputBaseFilename=adFactoryFeSetup_v{#MyAppVersion}
Compression=lzma
...
[Files]
Source: "version.ini"; DestDir: "{app}"; DestName: "version_fe.ini"; Flags: ignoreversion

; Source: "licenses\*"; DestDir: "{app}\licenses"; Flags: ignoreversion

Source: "conf\fe\adAccessoryPlugins.xml"; DestDir: "{app}\conf"; Flags: ignoreversion uninsneveruninstall

Source: "deploy\softwareupdate_fe.xml"; DestDir: "{app}\deploy"; DestName: "softwareupdate.xml"; Flags: ignoreversion uninsneveruninstall
...
[InstallDelete]
Type: files; Name: "{app}\version_fe.ini"
