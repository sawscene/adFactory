...
AllowNoIcons=yes
AllowUNCPath=no
OutputBaseFilename=adManagerSetup_v{#MyAppVersion}
Compression=lzma
...
Source: "bin\DashboardCustomizeTool.exe"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: management\adManager
Source: "bin\Dockingcontrollayout.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: management\adManager
Source: "bin\Infragistics4.Shared.v15.1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: management\adManager
Source: "bin\Infragistics4.Win.Misc.v15.1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: management\adManager
Source: "bin\Infragistics4.Win.UltraWinDock.v15.1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: management\adManager
Source: "bin\Infragistics4.Win.v15.1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: management\adManager
Source: "bin\Ionic.Zip.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: management\adManager
Source: "bin\log4net.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: management\adManager
...
Source: "bin\adSetupTool.exe"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: management\adManager
...
Source: "conf\adAndonCustomizeTool.xml"; DestDir: "{app}\conf"; Flags: onlyifdoesntexist; Components: management\adManager
Source: "conf\adAndonCustomizeToolItemList.ini"; DestDir: "{app}\conf"; Flags: ignoreversion; Components: management\adManager
Source: "conf\adAndonCustomizeToolLayoutInfo.cfg"; DestDir: "{app}\conf"; Flags: onlyifdoesntexist; Components: management\adManager
Source: "conf\adAndonCustomizeToolLayoutInfo.xml"; DestDir: "{app}\conf"; Flags: onlyifdoesntexist; Components: management\adManager
Source: "conf\Dashboard.ini"; DestDir: "{app}\conf"; Flags: onlyifdoesntexist; Components: management\adManager
Source: "conf\DashboardBackup.ini"; DestDir: "{app}\conf"; Flags: onlyifdoesntexist; Components: management\adManager
Source: "conf\InitialLayoutInfo"; DestDir: "{app}\conf"; Flags: onlyifdoesntexist; Components: management\adManager
...
begin
  case CurStep of
    ssInstall:// インストール開始前
      begin
        IsUpdate := FileExists(ExpandConstant('{app}\bin\adManagerApp.exe'));
      end;
