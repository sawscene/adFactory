...
public class MainApp extends Application {
    ...
    public static void main(String[] args) {
        logger.info("Startup the adMonitorCycleTaktTimePlugin.");
        try {
            //言語ファイルプラグイン読み込み.
            ...
            logger.info("Exit the adMonitorCycleTaktTimePlugin.");
        }
    }
}
