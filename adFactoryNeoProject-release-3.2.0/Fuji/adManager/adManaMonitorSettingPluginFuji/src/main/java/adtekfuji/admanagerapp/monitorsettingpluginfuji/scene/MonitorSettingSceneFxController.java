 ...
 */
package adtekfuji.admanagerapp.monitorsettingpluginfuji.scene;
 ...
 * @author nar-nakamura
 */
@FxScene(id = "MonitorSettingSceneFuji", fxmlPath = "/fxml/monitorsettingpluginfuji/monitor_setting_scene.fxml")
public class MonitorSettingSceneFxController implements Initializable {
