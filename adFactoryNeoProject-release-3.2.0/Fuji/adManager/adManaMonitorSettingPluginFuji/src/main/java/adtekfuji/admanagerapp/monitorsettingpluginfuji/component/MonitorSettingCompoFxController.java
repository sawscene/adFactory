 ...
 * @author nar-nakamura
 */
@FxComponent(id = "MonitorSettingCompoFuji", fxmlPath = "/fxml/monitorsettingpluginfuji/monitor_setting_compo.fxml")
public class MonitorSettingCompoFxController implements Initializable, ArgumentDelivery, ComponentHandler {
    ...
    private MonitorSettingFuji setting = null;

    // 最初に表示された情報
    private MonitorSettingFuji cloneSetting;
    ...
    private void createScene(long equipmentId, AndonMonitorTypeEnum monitorType, boolean isUpdateClone) {
        ...
        try {
            ...
            final MonitorSettingCompoFxController self = this;
            ...
            Task task = new Task<AndonSettingController>() {
                ...
                protected AndonSettingController call() throws Exception {
                    ...
                    if (Objects.isNull(monitorType)) {
                        ...
                        setting = (MonitorSettingFuji) monitorSettingFacade.getLineSetting(equipmentId, MonitorSettingFuji.class);
...
//                    AndonMonitorTypeEnum type = Objects.nonNull(setting.getMonitorType())
//                            ? setting.getMonitorType()
//                            : AndonMonitorTypeEnum.LINE_PRODUCT;

                    switch (type) {
                        case LINE_PRODUCT: {
                            LineMonitorSettingController controller = new LineMonitorSettingController(self, equipmentId, setting);
                            return controller;
                        }
                        case AGENDA: {
                            ...
                            AgendaMonitorSettingController controller = new AgendaMonitorSettingController(self, equipmentId, setting, null, true);
                            return controller;
                        }
                        default:
                            break;
                ...
                protected void succeeded() {
                    ...
                    try {
                        ...
                        if (isUpdateClone) {
                            MonitorSettingFuji setting = getRegistData();
    ...
    private boolean registData() {
        ...
        try {
            ...
            if (Objects.isNull(this.monitorId) || Objects.isNull(controller)) {
                return false;
            }

            if (!controller.isValidItems()) {
                return false;
            }
            ...
            final MonitorSettingFuji targetSetting = controller.getInputResult();
     ...
     * @return
     */
    private MonitorSettingFuji getRegistData() {
    ...
    private boolean isChanged() {
        MonitorSettingFuji currentSetting = getRegistData();
