 ...
 * @author nar-nakamura
 */
public class AdFactoryForFujiDbConnector extends JdbcConnector {

    // adFactoryDB の接続情報
    private static final int ADFACTORY_DB_PORT = 15432;
    private static final String ADFACTORY_DB_NAME = "adFactoryForFujiDB";
    ...
    /**
     * adFactoryForFujiDB 接続のインスタンスを取得する。
     *
     * @return 
     */
    public static JdbcConnector getInstance() {
        if (Objects.isNull(instance)) {
            String serviceUri = AdProperty.getProperties("ForFuji")
                    .getProperty("adFactoryForFujiServiceURI", "https://localhost/adFactoryForFujiServer/rest");
     ...
     */
    public AdFactoryForFujiDbConnector(String serverAddress, int dbPort, String dbName, String dbUser, String dbPassword) {
