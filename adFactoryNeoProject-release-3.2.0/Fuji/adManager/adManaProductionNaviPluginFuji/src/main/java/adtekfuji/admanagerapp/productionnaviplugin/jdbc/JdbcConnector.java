 ...
 */
package adtekfuji.admanagerapp.productionnaviplugin.jdbc;
...
public class JdbcConnector {
     ...
     */
    public JdbcConnector(String serverAddress, int dbPort, String dbName, String dbUser, String dbPassword) {
