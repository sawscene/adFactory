package adtekfuji.admanagerapp.analysisplugin;
...
public class MainApp extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        sp.setAppTitle(LocaleUtils.getString("key.AnalysisWork"));
        ...
        sc.setComponent("ContentNaviPane", "NormalDistributCompo");
        sc.setComponent("SideNaviPane", "AnalysisSubMenuCompo");
    }
...
//        LoginUserInfoEntity.getInstance().setName("admin");
        ...
        try {
            ...
            AdProperty.load(ClientPropertyConstants.ADPROPERTY_FOR_FUJI_TAG, ClientPropertyConstants.ADFACTORY_FOR_FUJI_CLIENT_PROPERTY_FILE);
