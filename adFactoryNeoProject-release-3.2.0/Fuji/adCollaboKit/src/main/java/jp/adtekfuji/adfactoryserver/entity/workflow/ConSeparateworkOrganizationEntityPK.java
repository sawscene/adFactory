 ...
 */
@Embeddable
public class ConSeparateworkOrganizationEntityPK implements Serializable {
    ...
    public ConSeparateworkOrganizationEntityPK() {
    }

    public ConSeparateworkOrganizationEntityPK(long fkWorkId, long fkOrganizationId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ConSeparateworkOrganizationEntityPK)) {
            return false;
        }
        ConSeparateworkOrganizationEntityPK other = (ConSeparateworkOrganizationEntityPK) object;
    ...
    public String toString() {
        return "jp.adtekfuji.adfactoryserver.entity.workflow.ConSeparateworkOrganizationEntityPK[ fkWorkId=" + fkWorkId + ", fkOrganizationId=" + fkOrganizationId + " ]";
    }
