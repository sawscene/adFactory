 ...
 */
@Embeddable
public class ConWorkEquipmentEntityPK implements Serializable {
    ...
    public ConWorkEquipmentEntityPK() {
    }

    public ConWorkEquipmentEntityPK(long fkWorkId, long fkEquipmentId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ConWorkEquipmentEntityPK)) {
            return false;
        }
        ConWorkEquipmentEntityPK other = (ConWorkEquipmentEntityPK) object;
    ...
    public String toString() {
        return "jp.adtekfuji.adfactoryserver.entity.work.ConWorkEquipmentEntityPK[ fkWorkId=" + fkWorkId + ", fkEquipmentId=" + fkEquipmentId + " ]";
    }
