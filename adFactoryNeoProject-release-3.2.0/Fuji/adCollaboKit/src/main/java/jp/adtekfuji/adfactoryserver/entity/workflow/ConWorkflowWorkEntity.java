...
@NamedQueries({
    @NamedQuery(name = "ConWorkflowWorkEntity.findAll", query = "SELECT c FROM ConWorkflowWorkEntity c ORDER BY c.workflowOrder"),
    @NamedQuery(name = "ConWorkflowWorkEntity.findByAssociationId", query = "SELECT c FROM ConWorkflowWorkEntity c WHERE c.associationId = :associationId ORDER BY c.workflowOrder"),
    @NamedQuery(name = "ConWorkflowWorkEntity.findByFkWorkflowId", query = "SELECT c FROM ConWorkflowWorkEntity c WHERE c.fkWorkflowId = :fkWorkflowId ORDER BY c.workflowOrder"),
    @NamedQuery(name = "ConWorkflowWorkEntity.findByFkWorkId", query = "SELECT c FROM ConWorkflowWorkEntity c WHERE c.fkWorkId = :fkWorkId ORDER BY c.workflowOrder"),
    @NamedQuery(name = "ConWorkflowWorkEntity.findBySkipFlag", query = "SELECT c FROM ConWorkflowWorkEntity c WHERE c.skipFlag = :skipFlag ORDER BY c.workflowOrder"),
    @NamedQuery(name = "ConWorkflowWorkEntity.findByWorkflowOrder", query = "SELECT c FROM ConWorkflowWorkEntity c WHERE c.workflowOrder = :workflowOrder ORDER BY c.workflowOrder"),
    @NamedQuery(name = "ConWorkflowWorkEntity.findByStandardStartTime", query = "SELECT c FROM ConWorkflowWorkEntity c WHERE c.standardStartTime = :standardStartTime ORDER BY c.workflowOrder"),
    @NamedQuery(name = "ConWorkflowWorkEntity.findByStandardEndTime", query = "SELECT c FROM ConWorkflowWorkEntity c WHERE c.standardEndTime = :standardEndTime ORDER BY c.workflowOrder"),
    @NamedQuery(name = "ConWorkflowWorkEntity.removeByFkWorkflowId", query = "DELETE FROM ConWorkflowWorkEntity c WHERE c.fkWorkflowId = :fkWorkflowId")})
public class ConWorkflowWorkEntity implements Serializable {
    ...
    public ConWorkflowWorkEntity(ConWorkflowWorkEntity in) {
    ...
    public ConWorkflowWorkEntity(Long fkWorkflowId, Long fkWorkId, Boolean skipFlag, Integer workflowOrder, Date standardStartTime, Date standardEndTime) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ConWorkflowWorkEntity)) {
            return false;
        }
        ConWorkflowWorkEntity other = (ConWorkflowWorkEntity) object;
    ...
    public String toString() {
        return "ConWorkflowWorkEntity{" + "associationId=" + associationId + ", fkWorkflowId=" + fkWorkflowId + ", fkWorkId=" + fkWorkId + ", skipFlag=" + skipFlag + ", workflowOrder=" + workflowOrder + ", standardStartTime=" + standardStartTime + ", standardEndTime=" + standardEndTime + '}';
    }
