...
public class ImportFormatFileUtil {
    ...
    private static WorkflowInfoFacade workflowInfoFacade;
    ...
    public static ImportFormatInfo load() {
        return load(CONF_PATH, IMPORT_FORMAT_FILE);
    }
     ...
     * @return
     */
    public static ImportFormatInfo load(String parent, String child) {
     ...
     * @return
     */
    public static ImportFormatInfo load(String path) {
     ...
     * @return
     */
    public static ImportFormatInfo load(File file) {
        logger.info("load");
    ...
    /**
     *
     * @param workflowInfoFacade
     */
    public static void setWorkflowInfoFacade(WorkflowInfoFacade workflowInfoFacade) {
        ImportFormatFileUtil.workflowInfoFacade = workflowInfoFacade;
    }
...
//            WorkflowInfoFacade workflowInfoFacade = new WorkflowInfoFacade();
            for (WorkflowRegexInfo regexInfo : info.getKanbanFormatInfo().getWorkflowRegexInfos()) {
                try {
                    WorkflowInfoEntity workflow = workflowInfoFacade.findName(URLEncoder.encode(regexInfo.getWorkflowName(), CHARSET), regexInfo.getWorkflowRev());
