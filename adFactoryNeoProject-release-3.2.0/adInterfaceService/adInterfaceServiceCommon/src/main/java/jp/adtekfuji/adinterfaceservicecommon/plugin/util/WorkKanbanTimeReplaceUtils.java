...
import jp.adtekfuji.adinterfaceservicecommon.plugin.common.WorkPlanWorkSettingDialogEntity;
...
//        KanbanTimeUtils.batchValidBreakTimeWorkKanbanOffsetTimes(timeReplaceData.getWorkKanbanInfoEntitys(), timeReplaceData.getBreakTimeInfoEntitys());
    ...
    public static List<HolidayInfoEntity> getHolidays(Date baseTime) {
        CashManager cm = CashManager.getInstance();
        List<HolidayInfoEntity> holidayList = cm.getItemList(HolidayInfoEntity.class, new ArrayList<>());
