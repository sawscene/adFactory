...
public class WorkPlanKanbanDefaultOffsetData {
    ...
    public BooleanProperty checkLotProductionProperty() {
        if (Objects.isNull(this.checkLotProductionProperty)) {
            this.checkLotProductionProperty = new SimpleBooleanProperty(this.checkLotProduction);
        }
        return this.checkLotProductionProperty;
    }
    ...
    public BooleanProperty checkOnePieceFlowProperty() {
        if (Objects.isNull(this.checkOnePieceFlowProperty)) {
            this.checkOnePieceFlowProperty = new SimpleBooleanProperty(this.checkOnePieceFlow);
        }
        return this.checkOnePieceFlowProperty;
    }
    ...
    public Boolean getCheckLotProduction() {
        if (Objects.nonNull(this.checkLotProductionProperty)) {
            return this.checkLotProductionProperty.get();
        }
        return this.checkLotProduction;
    }

    /**
     *
     * @param checkLotProduction
     */
    public void setCheckLotProduction(Boolean checkLotProduction) {
        if (Objects.nonNull(this.checkLotProductionProperty)) {
            this.checkLotProductionProperty.set(checkLotProduction);
        } else {
    ...
    public Boolean getCheckOnePieceFlow() {
        if (Objects.nonNull(this.checkOnePieceFlowProperty)) {
            return this.checkOnePieceFlowProperty.get();
        }
        return this.checkOnePieceFlow;
    }

    /**
     *
     * @param checkOnePieceFlow
     */
    public void setCheckOnePieceFlow(Boolean checkOnePieceFlow) {
        if (Objects.nonNull(this.checkOnePieceFlowProperty)) {
            this.checkOnePieceFlowProperty.set(checkOnePieceFlow);
        } else {
