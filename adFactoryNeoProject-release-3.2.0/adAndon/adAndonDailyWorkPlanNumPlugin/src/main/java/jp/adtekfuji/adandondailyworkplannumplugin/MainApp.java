...
public class MainApp extends Application {
    ...
    public static void main(String[] args) {
        try {
            logger.info("Startup the adAndonDailyWorkPlanNumPlugin.");
            ...
            logger.info("Exit the adAndonDailyWorkPlanNumPlugin.");
        }
    }
}
