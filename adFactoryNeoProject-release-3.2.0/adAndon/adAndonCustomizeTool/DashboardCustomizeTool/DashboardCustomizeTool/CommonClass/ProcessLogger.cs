...
namespace DashboardCustomizeTool.CommonClass
{
    ...
    public static class ProcessLogger
    {
        ...
        /// <param name="methodName">メソッド名</param>
        public static void StartMethodWithArgs(IEnumerable<string> args, string methodName = "")
        {
            var stack = new StackFrame(1);
        ...
        /// <param name="args">引数の列挙子</param>
        /// <param name="methodName">メソッド名</param>
        public static void StartMethodWithArgs(Type classType, IEnumerable<string> args, string methodName = "")
        {
            if (Logger != null)
            {
                var stack = new StackFrame(1);
