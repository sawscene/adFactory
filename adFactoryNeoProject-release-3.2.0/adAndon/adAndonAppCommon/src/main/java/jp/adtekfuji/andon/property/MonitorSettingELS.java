...
/**
 * 進捗モニタ設定情報 (エデックリンセイシステム様用)
 *
 * @author s-heya
 */
@XmlRootElement(name = "andonMonitorLineProductSetting")
@XmlAccessorType(XmlAccessType.PROPERTY)
public class MonitorSettingELS implements Serializable {
    ...
    // 当日実績進捗時間
    private IntegerProperty dailyLineAttenThresholdProperty;
    private IntegerProperty dailyLineWarnThresholdProperty;
    private Integer dailyLineAttenThreshold = 0;
    private Integer dailyLineWarnThreshold = 0;

    private Boolean autoCountdown = false;
    private Boolean followStart = false;

    public MonitorSettingELS() {
    }
     ...
     * @param monitorType
     */
    public MonitorSettingELS(AndonMonitorTypeEnum monitorType) {
     ...
     * @return 進捗モニタ設定
     */
    public static MonitorSettingELS create() {
        MonitorSettingELS setting = new MonitorSettingELS(AndonMonitorTypeEnum.LINE_PRODUCT);
    ...
    /**
     * 当日実績進捗時間 注意閾値 プロパティを取得する。
     *
     * @return
     */
    public IntegerProperty dailyLineAttenThresholdProperty() {
        if (Objects.isNull(this.dailyLineAttenThresholdProperty)) {
            this.dailyLineAttenThresholdProperty = new SimpleIntegerProperty(this.dailyLineAttenThreshold);
        }
        return this.dailyLineAttenThresholdProperty;
    }
     ...
     * @return
     */
    public Integer getDailyLineAttenThreshold() {
        if (Objects.nonNull(this.dailyLineAttenThresholdProperty)) {
            return this.dailyLineAttenThresholdProperty.get();
        }
        return this.dailyLineAttenThreshold;
    }

    /**
     * 当日実績進捗時間 注意閾値を設定する。
     *
     * @param dailyLineAttenThreshold
     */
    public void setDailyLineAttenThreshold(Integer dailyLineAttenThreshold) {
        if (Objects.nonNull(this.dailyLineAttenThresholdProperty)) {
            this.dailyLineAttenThresholdProperty.set(dailyLineAttenThreshold);
        } else {
            this.dailyLineAttenThreshold = dailyLineAttenThreshold;
        }
    }

    /**
     * 当日実績進捗時間 警告閾値 プロパティを取得する。
     *
     * @return
     */
    public IntegerProperty dailyLineWarnThresholdProperty() {
        if (Objects.isNull(this.dailyLineWarnThresholdProperty)) {
            this.dailyLineWarnThresholdProperty = new SimpleIntegerProperty(this.dailyLineWarnThreshold);
        }
        return this.dailyLineWarnThresholdProperty;
    }
     ...
     * @return
     */
    public Integer getDailyLineWarnThreshold() {
        if (Objects.nonNull(this.dailyLineWarnThresholdProperty)) {
            return this.dailyLineWarnThresholdProperty.get();
        }
        return this.dailyLineWarnThreshold;
    }

    /**
     * 当日実績進捗時間 警告閾値を設定する。
     *
     * @param dailyLineWarnThreshold
     */
    public void setDailyLineWarnThreshold(Integer dailyLineWarnThreshold) {
        if (Objects.nonNull(this.dailyLineWarnThresholdProperty)) {
            this.dailyLineWarnThresholdProperty.set(dailyLineWarnThreshold);
        } else {
            this.dailyLineWarnThreshold = dailyLineWarnThreshold;
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        final MonitorSettingELS other = (MonitorSettingELS) obj;
        return Objects.equals(this.getLineId(), other.getLineId());
    }

    @Override
    public String toString() {
        return "MonitorSettingELS{" + "lineIdProperty=" + lineIdProperty + ", titleProperty=" + titleProperty + ", startWorkTimeProperty=" + startWorkTimeProperty
                + ", endWorkTimeProperty=" + endWorkTimeProperty + ", dailyPlanNumProperty=" + dailyPlanNumProperty + ", montlyPlanNumProperty=" + montlyPlanNumProperty
                + ", resetTimeProperty=" + resetTimeProperty + ", cautionRetentionParcentProperty=" + cautionRetentionParcentProperty + ", cautionFontColorProperty=" + cautionFontColorProperty
                + ", cautionBackColorProperty=" + cautionBackColorProperty + ", warningRetentionParcentProperty=" + warningRetentionParcentProperty
                + ", warningFontColorProperty=" + warningFontColorProperty + ", warningBackColorProperty=" + warningBackColorProperty
                + ", dialyLineAttenThresholdProperty=" + dailyLineAttenThresholdProperty + ", dialyLineWarnThresholdProperty=" + dailyLineWarnThresholdProperty + '}';
    }
     ...
     */
    @Override
    public MonitorSettingELS clone() {
        MonitorSettingELS setting = new MonitorSettingELS();
        ...
        // 当日実績進捗時間
        setting.setDailyLineAttenThreshold(this.getDailyLineAttenThreshold());
        setting.setDailyLineWarnThreshold(this.getDailyLineWarnThreshold());
     ...
     * @return
     */
    public boolean equalsDisplayInfo(MonitorSettingELS setting) {
        boolean ret = false;
        if (Objects.equals(this.getTitle(), setting.getTitle())
                ...
                && Objects.equals(this.getDailyLineAttenThreshold(), setting.getDailyLineAttenThreshold())
                && Objects.equals(this.getDailyLineWarnThreshold(), setting.getDailyLineWarnThreshold())
