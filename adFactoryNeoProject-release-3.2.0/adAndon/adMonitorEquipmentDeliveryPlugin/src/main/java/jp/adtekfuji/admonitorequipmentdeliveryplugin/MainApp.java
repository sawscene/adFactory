...
public class MainApp extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        sc.trans("EquipmentDeliveryMain");
    }
    ...
    public static void main(String[] args) {
        try {
            logger.info("Startup the adMonitorEquipmentDeliveryPlugin.");
            ...
            logger.info("Exit the adMonitorEquipmentDeliveryPlugin.");
        }
    }
}
